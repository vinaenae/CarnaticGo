-- First name for dashboard greeting (from auth signUp user_metadata).
...
-- Optional: pull first_name from Auth metadata for accounts created before this migration.
