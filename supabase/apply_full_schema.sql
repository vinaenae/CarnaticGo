...
--   4. Quiz points (+1 correct + streak bonus, -1 wrong, floor at 0)
--   5. Shop (streak freeze, shruti box, profile badge)
--   6. Sing-with-tāla +5 quiz bonus (once per calendar day via RPC)
--   7. Hold-the-swara bests (per shruti key)
--
...
-- ----- 8. Hold the swara (best hold times per shruti) -----
